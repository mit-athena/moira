...
@multiple[@b[
get_machine_to_cluster_map, gmcm(]@i[machine, cluster]@b[)
=>]@i[ machine, cluster]
...
@multiple[@b[
get_cluster_data, gcld(]@i[cluster, label]@b[) =>]@i[ cluster, label,
data]
...
@multiple[@b[
get_list_info, glin(]@i[list]@b[) =>]@i[ list, active, public, hidden,
maillist, group, gid, ace_type, ace_name, description, modtime, modby,
modwith]
...
@multiple[@b[
expand_list_names, exln(]@i[list]@b[) =>]@i[ list]
...
ace_type, ace_name, description]@b[) =>]@i[]
...
group, gid, ace_type, ace_name, description]@b[) =>]@i[]
...
@multiple[@b[
get_ace_use, gaus(]@i[ace_type, ace_name]@b[) =>]@i[ object_type, object_name]
...
@multiple[@b[
qualified_get_lists, qgli(]@i[active, public, hidden, maillist,
group]@b[) =>]@i[ list]
...
@multiple[@b[
get_lists_of_member, glom(]@i[type, value]@b[) =>]@i[ list, active,
...
@multiple[@b[
qualified_get_server, qgsv(]@i[enable, inprogress, harderror]@b[)
=>]@i[ service]
...
@multiple[@b[
get_server_host_info, gshi(]@i[service, machine]@b[) =>]@i[ service,
...
inprogress, hosterror]@b[) =>]@i[ service, machine]
...
@multiple[@b[
set_server_host_internal, sshi(]@i[service, machine, override,
success, inprogress, hosterror, errmsg, lasttry, lastsuccess]@b[)
=>]@i[]
...
@multiple[
@b[ get_filesys_by_label, gfsl(]@i[name]@b[) =>]@i[ name, fstype,
...
@multiple[@b[
get_filesys_by_nfsphys, gfsn(]@i[machine, partition]@b[)
=>]@i[ name, fstype, machine, packname, mountpoint, access, comments,
...
@multiple[@b[
get_filesys_by_group, gfsg(]@i[list]@b[) =>]@i[ name, fstype,
machine, packname, mountpoint, access, comments, owner, owners,
create, lockertype, modtime, modby, modwith]
...
@multiple[@b[
update_filesys, ufil(]@i[name, newname, fstype, machine, packname,
mountpoint, access, comments, owner, owners, create, lockertype]@b[)
=>]@i[]
...
@multiple[@b[
delete_filesys, dfil(]@i[name]@b[) =>]@i[]
...
@multiple[@b[
get_nfsphys, gnfp(]@i[machine, dir]@b[) =>]@i[ machine, dir, device,
...
@multiple[@b[
add_nfsphys, anfp(]@i[machine, directory, device, status, allocated,
size]@b[) =>]@i[]
...
@multiple[@b[
update_nfsphys, unfp(]@i[machine, directory, device, status,
allocated, size]@b[) =>]@i[]
...
@multiple[@b[
adjust_nfsphys_allocation, ajnf(]@i[machine, directory, delta]@b[) =>]@i[]
...
@multiple[@b[
delete_nfsphys, dnfp(]@i[machine, directory]@b[) =>]@i[]
...
@multiple[@b[
get_nfs_quotas_by_partition, gnqp(]@i[machine, directory]@b[) =>]@i[
...
@multiple[@b[
get_zephyr_class, gzcl(]@i[class]@b[) =>]@i[ class, xmttype, xmtname,
...
@multiple[@b[
get_server_host_access, gsha(]@i[machine]@b[) =>]@i[ machine,
ace_type, ace_name, modtime, modby, modwith]
...
@multiple[@b[
add_server_host_access, asha(]@i[machine, ace_type, ace_name]@b[) =>]@i[]
...
@multiple[@b[
update_server_host_access, usha(]@i[machine, ace_type, ace_name]@b[)
=>]@i[]
...
@multiple[@b[
delete_server_host_access, dsha(]@i[machine]@b[) =>]@i[]
