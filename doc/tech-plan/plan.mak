...
@Marker(Make,Plan,X9700)
@FontFamily(Helvetica12)

@Define(BodyStyle, Font BodyFont, Spacing 1, Spread 0.8)
@Define(NoteStyle, Font BodyFont, FaceCode R, Spacing 1)
@Style(SingleSided, BindingMargin=0.3inch)
...
@Modify(Verbatim, spacing 1)
@Modify(Fnenv, Indent 1em, Font BodyFont, Facecode R)
...
@Define(Logotype, Use HDx, flushright, Font BodyFont, FaceCode B,
        spaces kept)
@Define(Title, Use HDx, flushright)
@Define(Author, Use HDx, flushright, FaceCode R, Above 0.2inch,
                 below 0.6 inch)
@Define(Hd1, Use HDx, Above 2, below 1)
@Define(Hd2, Use HDx, Above 2, below 1.3)
@Define(Hd3, Use HDx, Above 2, below 0.5)
@Define(Hd4, Use HDx, Above 0.3inch, Break before)
...
@Logotype[M. I. T.  PROJECT  ATHENA]
@comment[@picture(height = .4 inches, ScaleableLaser = owl.PS)]
@message[
(Can't get Athena logo either.  Oops....)
]
@imbed(title,
      Def=<@title[@parm(title)]>
      )
