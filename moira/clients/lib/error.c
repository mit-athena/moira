/* $Id: error.c,v 1.1 2000-08-10 02:05:35 zacheiss Exp $
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/clients/lib/error.c,v 1.1 2000-08-10 02:05:35 zacheiss Exp $");
