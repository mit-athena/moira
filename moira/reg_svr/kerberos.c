/* $Id: kerberos.c,v 1.1 1998-07-22 14:55:24 danw Exp $
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/reg_svr/kerberos.c,v 1.1 1998-07-22 14:55:24 danw Exp $");
